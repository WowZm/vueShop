<template>
    <div>
        ...
        <el-card class="box-card">
                ...
                <el-table-column label="操作" width="180px">
                    <template slot-scope="scope">
                        ...
                        <el-tooltip effect="dark" content="分配角色" placement="top" enterable="false">
                            <el-button type="waring" icon="el-icon-setting" size="mini" @click="setRole(scope.row)"></el-button>
                        </el-tooltip>
            ...
            :current-page="queryInfo.pagenume" :page-sizes="[1, 2, 5, 10]"
        ...
        width="50%" @close="setRoletDialogClosed">
            <div>
