            ...
            <el-table :data="rolesList" border stripe>
                            ...
                            <el-col :span="19">
                                ...
                                <el-row :class="[i2 === 0 ? '' : bdtop, vcenter]" v-for="(item2, i2) in item1.children" :key="item2.id">
                                    ...
                                    <el-col :span="18">
                                        ...
                                        :key="item3.id" closable @close="removeRightsById(scope.row, item3.id)">{{item3.authName}}</el-tag>
                                    </el-col>
                                </el-row>
                            </el-col>
                        </el-row>
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope" width="300px">
                        ...
                        <el-tooltip type="warning" icon="el-icon-setting" size="mini" @click="showSetRightDialog(scope.row)">分配权限</el-tooltip>
                    </template>
                </el-table-column>
            </el-table>
        </el-card>
...
export default {
    ...
    methods: {
        ...
        async getRolesList() {
            ...
            //     return this.$meaasge.error('获取角色列表失败！')
            // }
            // this.rolesList = data.res
